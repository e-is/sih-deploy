...
# Avoid error on Oracle database, from timezone
export CATALINA_OPTS="$CATALINA_OPTS  -Duser.timezone=+04:00"

# discourage address map swapping by setting Xms and Xmx to the same value
# http://confluence.atlassian.com/display/DOC/Garbage+Collector+Performance+Issues
export CATALINA_OPTS="$CATALINA_OPTS -Xms1792m"
export CATALINA_OPTS="$CATALINA_OPTS -Xmx1792m"
